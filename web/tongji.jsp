...
{
    var unit_id     = "3140732";
    var client_ip   = "183.61.187.161";
    var server_time = "1373683233";
    var verify_code = "c52d6cf7";
    var type        = "0";
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
    var icon_link_host="tongji.linezing.com";
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/3140732/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
lz_main();
</script>
