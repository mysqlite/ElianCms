...
<html lang="zh-CN">
	...
	<body>
		...
		<form id="searchCompanyMedicineForm" method="post" action="${path}/front/searchCompanyMedicine!search.action">
	...
	<script type="text/javascript">
		...
		function submitForm(){
			document.getElementById("searchCompanyMedicineForm").submit();
		}
	</script>
</html>