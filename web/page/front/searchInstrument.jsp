...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
		<c:import url="searchInstrumentHeader.jsp" charEncoding="utf-8"/>
	...
	　　    	}
		...
		<div class="section">
			<div class="section_main">
				...
				<form id="searchInstrumentForm" method="post" action="${path}/front/searchInstrument!search.action">
							...
							<div class="last">
								<div class="wrap_search">
									<div class="search">
										...
										<input id="searchButton" onclick="submitSearch('searchInstrumentForm')" class="ips" value="搜索" />
									</div>
								</div>
							</div>
						</div>
