...
<html lang="zh-CN">
	<head>
		...
		<script type="text/javascript">
			...
			var setting = {
				...
				async: {
                 enable: true,
                 url:"${path}/admin/doctorImport!tree.action",
                 autoParam:["id", "type"],
                 dataFilter: filter
             	}
			};
			...
			function filter(treeId, parentNode, data) {
			    ...
			    for(var i=0; i<data.length; i++){  
			    	...
			    	else if(data[i].TYPE=="department"){
			...
			function save(formId) {
				...
				form.action = '${path}/admin/doctor_cImport!save.action' +"?ids=" + ids;
				form.submit();
			}
			//-->
		</script>
	...
	<body class="input">
		...
		<div class="body">
			<form id="editDoctorImportForm" method="post">
				...
				<div class="divInputTable">
		            ...
		            <div id="typeDiv">
		            	<table>
			            	<tr>
								<th>
									<input id="checkAll" type="checkbox" onclick="selectCheckAll('checkAll')"/>&nbsp;<span>*</span>医生
								</th>
								<td>
				...
				<div class="buttonArea">
					...
					<input class="formButton" value="保 存" type="button" onclick="save('editDoctorImportForm');"/>&nbsp;&nbsp;
