...
<html lang="zh-CN">
	...
	initSetting=function(){
         var setting = {
                ...
                async: {
                    ...
                    autoParam:["paramId"],
                    otherParam:{"requType":"doctor","hospName":G("hospName").value}
                },
                callback: {
	...
	function ajaxDataFilter(treeId, parentNode, data) {
	    ...
	    for(var i=0; i<data.length; i++){    
	    	...
	    	if(data[i].type==AREA){
	    		...
	    		urls='${path}/admin/doctor!list.action?ztree=true&departId='+data[i].id+"&hospId="+parentNode.realId;
	...
	<script type="text/javascript">
	    function onloadArea(){
	    	        var thisAreaCode=0;
	    	        if('${_substation.areaId}'!=""){
	    	        	thisAreaCode='${_substation.areaId}';
