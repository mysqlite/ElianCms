...
<html lang="zh-CN">
	<head>
		...
		<script type="text/javascript">
			...
			var setting = {
				...
				async: {
                 enable: true,
                 url:"${path}/admin/medicineImport!tree.action",
                 autoParam:["id", "type"],
                 dataFilter: filter
             	}
			};
			...
			function save(formId) {
				...
				form.action = '${path}/admin/medicine_cImport!save.action' +"?ids=" + ids;
				form.submit();
			}
			//-->
		</script>
	...
	<body class="input">
		...
		<div class="body">
			<form id="editMedicineImportForm" method="post">
				...
				<div class="divInputTable">
		            ...
		            <div id="typeDiv">
		            	<table>
			            	<tr>
								<th>
									<input id="checkAll" type="checkbox" onclick="selectCheckAll('checkAll')"/>&nbsp;<span>*</span>药品
								</th>
								<td>
				...
				<div class="buttonArea">
					...
					<input class="formButton" value="保 存" type="button" onclick="save('editMedicineImportForm');"/>&nbsp;&nbsp;
