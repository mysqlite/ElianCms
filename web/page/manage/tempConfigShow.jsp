		            	...
		            	<ul class="inputList">		            				               
			                <li class="inputList-li">			                	
			                	<div class="listItem">
	                     			...
	                     			<span class="txt">${templateConfig.template.tempName}</span>
			                   	</div>			                   		                   
			                </li>	
			                <li class="inputList-li">
			                	<div class="listItem">
			                		<label class="lbl-ipt-tit">
	                     			...
	                     			<span class="txt">${templateConfig.areaId}</span>		                     			
			                	</div>
			                	<div class="listItem">
			                		<label class="lbl-ipt-tit">
		                     			<span class="star">*</span>选择栏目：
		                     		</label>		                     		         		
	                     			<span class="txt">${templateConfig.channelSet.channelName}</span>
			                	</div>
			                </li>
			                <li class="inputList-li">
			                	<div class="listItem">
		                     		...
		                     		<span class="txt">${templateConfig.creater}</span>
			                   	</div>
			                   	<div class="listItem">
		                       		<label class="lbl-ipt-tit">
		                     			<span class="star">*</span>创建时间：
		                     		</label>	
		                     		<span class="txt"><s:date name="templateConfig.createTime" format="yyyy-MM-dd HH:mm:ss" /></span>	                     		
			                   	</div>
			                </li>
			            </ul>
			        </div>
