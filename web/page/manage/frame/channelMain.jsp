...
<html lang="zh-CN">
	...
	<frameset id=mainFrameset frameSpacing=0 name=mainFrameset border=0 cols=220,6,* frameBorder=no>
        <frame id=menuFrame noResize src="${path}/admin/navigation.action?url=channelLeft" frameBorder=no name=menuFrame><!--菜单-->
        ...
        <frame id=mainFrame noResize src="${path}/admin/channel!list.action" frameBorder=no name=mainFrame><!--主内容区域-->
    </frameset>
</html>
