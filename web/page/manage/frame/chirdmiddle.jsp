...
$().ready(function() {
	var $main = $("#main");
	$main.click( function() {
		var mainFrameset = window.parent.window.document.getElementById("subFrameset");
		if(mainFrameset.cols == "220,6,*"||mainFrameset.cols == "220,6,*") {
            ...
            var menuFrame = window.parent.window.document.getElementById("submenuFrame")//.getElementById("body");
		} else{
