...
<html lang="zh-CN">
    ...
    <body class="list">
     <script type="text/javascript">
	    function sim(form){
	        form.action='${path}'+"/logThisUser!batchDelete.action";
	        form.submit();
	    }
    </script>
    <form id="logForm" name="logForm" method="post" action="${path}/admin/logThisUser!list.action">
    <div class="main-top-hd clearfix">
        <h3 class="cur"><a href="javascript:void(0);">个人日志</a></h3>
        <c:if test="${delete}">
