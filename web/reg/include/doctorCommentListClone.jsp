...
<div class="reply_comment" id="reply_comment">
 <form action="${path}/reg/regDoctorClone!detial.action#reply_comment" method="post" id="replyComment" name="replyComment" >
 <input type="hidden" name="cssStr" value="${cssStr}">
  ...
  <script type="text/javascript">
   function toGood(id){
       $.post('${path}/reg/regDoctorClone!saveGood.action',{"id":id},function(result){
          if(result){
   ...
   function toPoor(id){
       $.post('${path}/reg/regDoctorClone!savePoor.action',{"id":id},function(result){
          if(result){
