...
<html lang="zh-CN">
	<head>
		...
		<link rel="stylesheet" href="http://style.elian.cc/hosp/cmsbuild/blue/reg_doc_details.css" type="text/css" media="screen" />
...
<script type="text/javascript">
	function submitRegister(doctorId, rank, dateYhd, dateHm){
		...
		parent.window.location = '${path}/reg/regRegisterConfirmClone!confirm.action?i='+doctorId+'&r='+rank+'&dy='+dateYhd+'&dh='+dateHm;
		//showDialog("挂号信息", '${path}/reg/regRegisterConfirmClone!confirm.action?i='+doctorId+'&r='+rank+'&dy='+dateYhd+'&dh='+dateHm, 1024, 768);
	}
</script>
