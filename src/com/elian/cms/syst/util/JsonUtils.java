...
import com.elian.cms.syst.util.FilePathUtils.ImgPath;
...
public class JsonUtils {
	...
	public static void main(String[] arg) throws Exception{ 
		String bb="[{\"path\": \"image/a/b/vc.gif\" }," + 
		"{\"path\": \"image/a/b/vc.gif\"},{\"path\": \"image/a/b/vc.gif\"}," + 
		"{ \"path\": \"image/a/b/vc.gif\"},{\"path\": \"image/a/b/vc.gif\"}]";
		ImgPath path=new ImgPath();
		Object[] as=JsonUtils.getDTOArray(bb,path.getClass());
		System.out.println(" object : " + as); 
		@SuppressWarnings("unused")
		List<ImgPath> js=(List<ImgPath>) jsonArrayStrToList(bb,path.getClass());
		} 
