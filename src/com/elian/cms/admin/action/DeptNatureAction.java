...
@Component
@Scope("prototype")
public class DeptNatureAction extends BaseAction {
	...
	private SelectItem deptType;
	
	public String  list() {
		typeService.findByTypePage(pagination, ElianUtils.DEPT_NATURE);
		deptType=ElianUtils.getDeptType();
		return LIST;
	}
	...
	public SelectItem getDeptType() {
		return deptType;
	}
	
	public void setDeptType(SelectItem selectItem) {
		this.deptType= selectItem;
	}
}
